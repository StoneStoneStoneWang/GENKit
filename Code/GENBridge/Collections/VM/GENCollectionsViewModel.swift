...
public struct GENCollectionsViewModel: GENViewModel {
    ...
    public struct WLOutput {
        ...
        public let collectionData: BehaviorRelay<[GENCircleBean]> = BehaviorRelay<[GENCircleBean]>(value: [])
        ...
        headerRefreshData
            .drive(onNext: { (result) in
                ...
                case let .fetchList(items):
                    ...
                    output.collectionData.accept(items as! [GENCircleBean])
